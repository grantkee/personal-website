...
export const items: WorkItem[] = [
  {
    ...
    title: 'Migrated a live ERC-20 to be the native token of its own Layer 1',
...

  {
    ...
    title: 'Building a blockchain secured by mobile carriers',
...

  {
    ...
    title: 'Removed reliance on single hardware keys for contract deployment',
    ...
    proof: [
      {
        label: 'shared deployment utilities',
...

  {
    ...
    title: 'Security-first software development lifecycle',
    ...
    proof: [
      {
        label: 'open competition on Cantina',
...

  {
    ...
    title: 'Architected an off-chain attestation service that keeps mint authority with the issuer',
    ...
    proof: [
      ...
      { label: 'Telcoin Digital Asset Bank', href: 'https://bank.telco.in/' },
    ],
  },

  {
    kicker: 'Interoperability',
    title: 'Prioritize security with bridge infrastructure',
    ...
    proof: [
      {
        label: 'verifier mesh specification',
