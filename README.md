...
Personal site for Grant Kee, Chief Technology Officer, Telcoin Autonomous Operations.
...
"targeted". Verb-first openers. Adjectives may describe kind ("regulated stablecoin"), never
quality. Numbers exact or explicitly bounded. One em dash per paragraph.
...
Naming is mechanical. **Telcoin Autonomous Operations (TAO)** for role, mandate, reporting,
budget and hiring. **Telcoin Association** only for governance, the council and the GitHub
org, never as employer. **Telcoin Network** is only ever the chain. "Telcoin Platform" and
"Telcoin Application Network" are retired and must not come back.
